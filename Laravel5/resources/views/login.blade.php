...
<head>
		<meta charset="UTF-8">
		<title>@yield( 'page_title', 'Halaman Awal') | Laboraturium FW</title>
...
<body>
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<a href="{{url('/')}}" class="navbar-barand">Laravel-5</a>
					</div>
			</div>
		</nav>
...
{!! Form::close() !!}
           ...
           <footer class="container">
               ...
               <span><i class="fa fa-google" style="color: #1da1f2"></i>@Kara</span></a></footer>
       </nav>
